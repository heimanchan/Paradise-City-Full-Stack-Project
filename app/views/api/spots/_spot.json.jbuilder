json.extract! spot, :id, :title, :address, :lat, :lng, :max_guests, :num_bedrooms, :num_beds, :price, :ratings, :description, :heat, :pool, :shampoo, :tv, :wifi, :air_conditioning, :iron, :hair_dryer, :first_aid, :laundry, :average_rating
